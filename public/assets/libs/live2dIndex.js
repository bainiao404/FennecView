...
!(function (t, e) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ...
          : e(
                (((t = 'undefined' != typeof globalThis ? globalThis : t || self).PIXI = t.PIXI || {}),
    ...
    class _ extends e.EventEmitter {
        ...
        setExpression(t) {
            return __async(this, null, function* () {
                if (
                    ('number' != typeof t && (t = this.getExpressionIndex(t)), !(t > -1 && t < this.definitions.length))
                )
                    return !1
        ...
        reserve(t, e, i) {
            ...
            if (1 === i) {
                if (0 !== this.currentPriority)
                    return (
                        l.log(this.tag, 'Cannot start idle motion because another motion is playing.', this.dump(t, e)),
                        !1
                    )
        ...
        start(t, e, i, s) {
            if (1 === s) {
                if ((this.setReservedIdle(void 0, void 0), 0 !== this.currentPriority))
                    return (
                        l.log(this.tag, 'Cannot start idle motion because another motion is playing.', this.dump(e, i)),
                        !1
                    )
            } else {
        ...
        U = class {
            ...
            static setupLive2DModel(t, e, i) {
                return __async(this, null, function* () {
                    ...
                    yield L(U.live2DModelMiddlewares, { live2dModel: t, source: e, options: i || {} }),
                        yield a,
                        t.emit('load')
                })
            }
    ...
    class V {
        ...
        set autoInteract(t) {
            t !== this._autoInteract &&
                (t ? this.on('pointertap', G, this) : this.off('pointertap', G, this), (this._autoInteract = t))
        }
        registerInteraction(t) {
            t !== this.interactionManager &&
                (this.unregisterInteraction(),
                this._autoInteract && t && ((this.interactionManager = t), t.on('pointermove', j, this)))
        }
        unregisterInteraction() {
            var t
            this.interactionManager &&
                (null == (t = this.interactionManager) || t.off('pointermove', j, this),
        ...
        init() {
            super.init(),
                this.settings.initParams &&
                    this.settings.initParams.forEach(({ id: t, value: e }) => this.coreModel.setParamFloat(t, e)),
                this.settings.initOpacities &&
                    this.settings.initOpacities.forEach(({ id: t, value: e }) => this.coreModel.setPartsOpacity(t, e)),
    ...
    const ct = class {
        ...
        static quadraticEquation(t, e, i) {
            return this.abs(t) < ct.Epsilon
                ? this.abs(e) < ct.Epsilon
                    ? -i
                    : -i / e
    ...
    class mt {
        ...
        static multiply(t, e, i) {
            ...
            for (let r = 0; r < 4; ++r)
                for (let i = 0; i < 4; ++i) for (let a = 0; a < 4; ++a) s[i + 4 * r] += t[a + 4 * r] * e[i + 4 * a]
    ...
    class Ct {
        static startUp(t) {
            ...
            if (
                ...
                (xt = t),
                xt && Live2DCubismCore.Logging.csmSetLogFunction(xt.logFunction),
                (yt = !0),
                yt)
            ) {
        ...
        updateParameters(t, e, i) {
            ...
            ;(s =
                ...
                (0 == this._fadeOutSeconds || e.getEndTime() < 0
                    ? 1
                    : gt.getEasingSine((e.getEndTime() - i) / this._fadeOutSeconds))),
                e.setState(i, s),
    ...
    class Bt {
        ...
        startMotion(t, e, i) {
            ...
            return (
                (s = new At()), (s._autoDelete = e), (s._motion = t), this._motions.push(s), s._motionQueueEntryHandle
            )
        }
        isFinished() {
            let t = 0
    ...
    class kt {
        ...
        getEyeBlinkParameters() {
            var t, e
            return null == (e = null == (t = this.groups) ? void 0 : t.find((t) => 'EyeBlink' === t.Name))
                ? void 0
                : e.Ids
        }
        getLipSyncParameters() {
            var t, e
            return null == (e = null == (t = this.groups) ? void 0 : t.find((t) => 'LipSync' === t.Name))
                ? void 0
                : e.Ids
        }
    }
    ...
    var Ht = ((t) => (
        (t[(t.EvaluationOptionFlag_AreBeziersRistricted = 0)] = 'EvaluationOptionFlag_AreBeziersRistricted'), t
    ))(Ht || {})
    function qt(t, e, i) {
        const s = new Gt()
        ...
        for (let l = s.baseSegmentIndex; l < a; ++l)
            if (
                ((o =
                    ...
                    (t.segments[l].segmentType == Vt.CubismMotionSegmentType_Bezier ? 3 : 1)),
                t.points[o].time > i)
            ) {
                r = l
                break
    ...
    class ee extends Et {
        ...
        doUpdateParameters(t, e, i, s) {
            ...
            this._eyeBlinkParameterIds.length > l &&
                bt('too many eye blink targets : {0}', this._eyeBlinkParameterIds.length),
                this._lipSyncParameterIds.length > l &&
                    bt('too many lip sync targets : {0}', this._lipSyncParameterIds.length)
            const u =
                    this._fadeInSeconds <= 0 ? 1 : gt.getEasingSine((e - s.getFadeInStartTime()) / this._fadeInSeconds),
                c =
                    this._fadeOutSeconds <= 0 || s.getEndTime() < 0
                        ? 1
                        : gt.getEasingSine((s.getEndTime() - e) / this._fadeOutSeconds)
            let g,
                m,
                p,
                _ = r
            ...
            for (m = 0; m < this._motionData.curveCount && f[m].type == Nt.CubismMotionCurveTarget_Model; ++m)
                (g = te(this._motionData, m, _)),
                    f[m].id == this._modelCurveIdEyeBlink ? (n = g) : f[m].id == this._modelCurveIdLipSync && (o = g)
                ...
                if (f[m].fadeInTime < 0 && f[m].fadeOutTime < 0) a = r + (g - r) * i
                    ...
                    ;(t =
                        f[m].fadeInTime < 0
                            ...
                            : 0 == f[m].fadeInTime
                              ? 1
                              : gt.getEasingSine((e - s.getFadeInStartTime()) / f[m].fadeInTime)),
                        (i =
                            f[m].fadeOutTime < 0
                                ? c
        ...
        parse(t) {
            ...
            ;(this._fadeInSeconds = void 0 !== s ? (s < 0 ? 1 : s) : 1),
                ...
                (this._motionData.segments = Array.from({ length: e.getMotionTotalSegmentCount() }).map(
                    () => new jt(),
                )),
                ...
                for (let l = 0; l < e.getMotionCurveSegmentCount(n); ) {
                    0 == l
                        ? ((this._motionData.segments[o].basePointIndex = a),
                          (this._motionData.points[a] = new Gt(
                    ...
                    switch (e.getMotionCurveSegment(n, l)) {
                        ...
                        case Vt.CubismMotionSegmentType_Bezier:
                            ;(this._motionData.segments[o].segmentType = Vt.CubismMotionSegmentType_Bezier),
                                ...
                                (this._motionData.points[a + 1] = new Gt(
                                    e.getMotionCurveSegment(n, l + 3),
                                    e.getMotionCurveSegment(n, l + 4),
                                )),
                                (this._motionData.points[a + 2] = new Gt(
            ...
            switch (this._blinkingState) {
                case ne.EyeState_Closing:
                    ;(s = (this._userTimeSeconds - this._stateStartTimeSeconds) / this._closingSeconds),
                        s >= 1 &&
                            ((s = 1),
                            (this._blinkingState = ne.EyeState_Closed),
                ...
                case ne.EyeState_Closed:
                    ;(s = (this._userTimeSeconds - this._stateStartTimeSeconds) / this._closedSeconds),
                        s >= 1 &&
                            ((this._blinkingState = ne.EyeState_Opening),
                            (this._stateStartTimeSeconds = this._userTimeSeconds)),
                        (i = 0)
                    break
                ...
                case ne.EyeState_Interval:
                    this._nextBlinkingTime < this._userTimeSeconds &&
                        ((this._blinkingState = ne.EyeState_Closing),
                        (this._stateStartTimeSeconds = this._userTimeSeconds)),
                        (i = 1)
                    break
    ...
    class ce {
        constructor() {
            ...
            // 预分配颜色通道以提升初始化速度
            this._channelColors.push(this._createColor(1, 0, 0, 0))
            this._channelColors.push(this._createColor(0, 1, 0, 0))
            this._channelColors.push(this._createColor(0, 0, 1, 0))
            this._channelColors.push(this._createColor(0, 0, 0, 1))
        }

        _createColor(r, g, b, a) {
            const color = new ft()
            color.R = r
            color.G = g
            color.B = b
        ...
        getMaskRenderTexture() {
            ...
            const gl = this.gl // 缓存 gl 对象减少属性查找
            ...
            gl.bindFramebuffer(gl.FRAMEBUFFER, ue) // ue 应为外部全局变量(通常为 default fbo)
            this._maskTexture = new ge(this._currentFrameNo, fbo)

            return fbo
        }

        // 优化：剥离数组长度读取，减少嵌套结构判断，提升热点循环效率
        calcClippedDrawTotalBounds(t, e) {
            ...
            const list = e._clippedDrawableIndexList
            const listLen = list.length

            for (let n = 0; n < listLen; n++) {
                const drawableIndex = list[n]
                const vertexCount = t.getDrawableVertexCount(drawableIndex)
                const vertices = t.getDrawableVertices(drawableIndex)

                let dMinX = Number.MAX_VALUE,
                    dMinY = Number.MAX_VALUE
                let dMaxX = Number.MIN_VALUE,
                    dMaxY = Number.MIN_VALUE

                const maxVertices = vertexCount * Pt
                // 内部热循环
                for (let v = vt; v < maxVertices; v += Pt) {
                    const vx = vertices[v]
            ...
            if (!isUsing) {
                ...
                e._isUsing = true
                e._allClippedDrawRect.x = minX
                e._allClippedDrawRect.y = minY
                e._allClippedDrawRect.width = maxX - minX
                e._allClippedDrawRect.height = maxY - minY
            }
        }

        // 优化：缓存 gl，加入 if (!maskCtx._isUsing) continue; 提前阻断多余矩阵计算
        setupClippingContext(t, e) {
            this._currentFrameNo++
            let usingCount = 0

            const maskList = this._clippingContextListForMask
            const maskListLen = maskList.length

            for (let s = 0; s < maskListLen; s++) {
                const maskCtx = maskList[s]
                this.calcClippedDrawTotalBounds(t, maskCtx)
                if (maskCtx._isUsing) usingCount++
            }

            if (usingCount > 0) {
                const gl = this.gl
                gl.viewport(0, 0, this._clippingMaskBufferSize, this._clippingMaskBufferSize)
                this._maskRenderTexture = this.getMaskRenderTexture()

                e.getMvpMatrix()
                e.preDraw()
                this.setupLayoutBounds(usingCount)

                gl.bindFramebuffer(gl.FRAMEBUFFER, this._maskRenderTexture)
                gl.clearColor(1, 1, 1, 1)
                gl.clear(gl.COLOR_BUFFER_BIT)

                for (let i = 0; i < maskListLen; i++) {
                    const maskCtx = maskList[i]
                    if (!maskCtx._isUsing) continue // 关键优化：跳过未使用的 Context

                    const rect = maskCtx._allClippedDrawRect
                    const layout = maskCtx._layoutBounds

                    this._tmpBoundsOnModel.setRect(rect)
                    this._tmpBoundsOnModel.expand(rect.width * 0.05, rect.height * 0.05)

                    const scaleX = layout.width / this._tmpBoundsOnModel.width
                    const scaleY = layout.height / this._tmpBoundsOnModel.height
                    const transX = -this._tmpBoundsOnModel.x
                    const transY = -this._tmpBoundsOnModel.y

                    // 遮罩用矩阵
                    this._tmpMatrix.loadIdentity()
                    this._tmpMatrix.translateRelative(-1, -1)
                    this._tmpMatrix.scaleRelative(2, 2)
                    this._tmpMatrix.translateRelative(layout.x, layout.y)
                    this._tmpMatrix.scaleRelative(scaleX, scaleY)
                    this._tmpMatrix.translateRelative(transX, transY)
                    ...
                    maskCtx._matrixForMask.setMatrix(this._tmpMatrixForMask.getArray())
                    maskCtx._matrixForDraw.setMatrix(this._tmpMatrixForDraw.getArray())

                    const clipCount = maskCtx._clippingIdCount
                    const clipList = maskCtx._clippingIdList

                    for (let j = 0; j < clipCount; j++) {
                        const clipId = clipList[j]
                        if (t.getDrawableDynamicFlagVertexPositionsDidChange(clipId)) {
                            e.setIsCulling(t.getDrawableCulling(clipId) !== 0)
                            e.setClippingContextBufferForMask(maskCtx)
                            e.drawMesh(
                                t.getDrawableTextureIndices(clipId),
                                t.getDrawableVertexIndexCount(clipId),
                                t.getDrawableVertexCount(clipId),
                                t.getDrawableVertexIndices(clipId),
                                t.getDrawableVertices(clipId),
                                t.getDrawableVertexUvs(clipId),
                                t.getDrawableOpacity(clipId),
                ...
                gl.bindFramebuffer(gl.FRAMEBUFFER, ue)
                e.setClippingContextBufferForMask(null)
                gl.viewport(de[0], de[1], de[2], de[3])
            }
        }

        // 优化：避免 for 循环里大量进行 `~~` 类型转换，将除法转换为乘法运算加速
        setupLayoutBounds(t) {
            const widthDiv = Math.floor(t / 4)
            const remainder = t % 4
            let s = 0
            const maskList = this._clippingContextListForMask
            ...
            for (let i = 0; i < maskList.length; i++) {
                if (maskList[i]._isUsing) usingMaskList.push(maskList[i])
            }

            for (let r = 0; r < 4; r++) {
                const count = widthDiv + (r < remainder ? 1 : 0)
                if (count === 0) continue

                if (count === 1) {
                    const ctx = usingMaskList[s++]
                    ctx._layoutChannelNo = r
                    ctx._layoutBounds.x = 0
                    ctx._layoutBounds.y = 0
                    ctx._layoutBounds.width = 1
                    ctx._layoutBounds.height = 1
                } else if (count === 2) {
                    for (let e = 0; e < 2; e++) {
                        const ctx = usingMaskList[s++]
                        ctx._layoutChannelNo = r
                        ctx._layoutBounds.x = 0.5 * (e % 2)
                        ctx._layoutBounds.y = 0
                        ctx._layoutBounds.width = 0.5
                        ctx._layoutBounds.height = 1
                    }
                } else if (count <= 4) {
                    for (let e = 0; e < count; e++) {
                        ...
                        ctx._layoutChannelNo = r
                        ctx._layoutBounds.x = 0.5 * (e % 2)
                        ctx._layoutBounds.y = 0.5 * Math.floor(e / 2)
                        ctx._layoutBounds.width = 0.5
                        ctx._layoutBounds.height = 0.5
                    }
                } else if (count <= 9) {
                    const step = 1 / 3 // 缓存除法为乘法
                    for (let e = 0; e < count; e++) {
                        const ctx = usingMaskList[s++]
                        ctx._layoutChannelNo = r
                        ctx._layoutBounds.x = (e % 3) * step
                        ctx._layoutBounds.y = Math.floor(e / 3) * step
                        ctx._layoutBounds.width = step
                        ctx._layoutBounds.height = step
                    }
                } else if (typeof a !== 'undefined' && a.supportMoreMaskDivisions && count <= 16) {
                    const step = 0.25
                    for (let e = 0; e < count; e++) {
                        const ctx = usingMaskList[s++]
                        ctx._layoutChannelNo = r
                        ctx._layoutBounds.x = (e % 4) * step
                        ctx._layoutBounds.y = Math.floor(e / 4) * step
                        ctx._layoutBounds.width = step
                        ctx._layoutBounds.height = step
                    }
                } else {
                    Tt('not supported mask count : {0}', count)
                }
            }
        }
        ...
        findSameClip(t, e) {
            const maskList = this._clippingContextListForMask
            const len = maskList.length
            for (let i = 0; i < len; i++) {
                const ctx = maskList[i]
                if (ctx._clippingIdCount !== e) continue

                let matchCount = 0
                const clipList = ctx._clippingIdList
                for (let j = 0; j < e; j++) {
                    const id = clipList[j]
                    for (let k = 0; k < e; k++) {
                        if (t[k] === id) {
        ...
        release() {
            const maskList = this._clippingContextListForMask
            if (maskList) {
                for (let r = 0; r < maskList.length; r++) {
                    if (maskList[r]) maskList[r].release()
                }
            }
            ...
            const gl = this.gl
            if (this._maskTexture && gl) {
                gl.deleteFramebuffer(this._maskTexture.texture)
                this._maskTexture = void 0
            }
            if (this._colorBuffer && gl) {
                gl.deleteTexture(this._colorBuffer)
                this._colorBuffer = null
            }
        }
        ...
        initialize(t, e, i, s) {
            for (let r = 0; r < e; r++) {
                ...
                let ctx = this.findSameClip(i[r], s[r])
                if (ctx == null) {
                    ctx = new me(this, i[r], s[r])
                    this._clippingContextListForMask.push(ctx)
                }
                ctx.addClippedDrawable(r)
                this._clippingContextListForDraw.push(ctx)
            }
        }
    ...
    class pe {
        ...
        setupShaderProgram(t, e, i, s, r, a, o, n, l, h, d, u, c) {
            if (!d) Tt('NoPremultipliedAlpha is not allowed')
            if (this._shaderSets.length === 0) this.generateShaders()

            // 【性能优化 1】缓存 WebGL 上下文，避免在热路径中进行数百次的 this.gl 属性查找
            const gl = this.gl
            const f = t.getClippingContextBufferForMask()
            const isMaskSetup = f != null

            let shaderSet, blendSrc, blendDst, blendSrcAlpha, blendDstAlpha

            // 1. 确定使用的 Shader 和 混合模式
            if (isMaskSetup) {
                shaderSet = this._shaderSets[_e.ShaderNames_SetupMask]
                blendSrc = gl.ZERO
                blendDst = gl.ONE_MINUS_SRC_COLOR
                blendSrcAlpha = gl.ZERO
                blendDstAlpha = gl.ONE_MINUS_SRC_ALPHA
            } else {
                const drawBuffer = t.getClippingContextBufferForDraw()
                const shaderOffset = drawBuffer != null ? (c ? 2 : 1) : 0

                switch (l) {
                    case _t.CubismBlendMode_Additive:
                        shaderSet = this._shaderSets[_e.ShaderNames_AddPremultipliedAlpha + shaderOffset]
                        blendSrc = gl.ONE
                        blendDst = gl.ONE
                        blendSrcAlpha = gl.ZERO
                    ...
                    case _t.CubismBlendMode_Multiplicative:
                        shaderSet = this._shaderSets[_e.ShaderNames_MultPremultipliedAlpha + shaderOffset]
                    ...
                    default:
                        shaderSet = this._shaderSets[_e.ShaderNames_NormalPremultipliedAlpha + shaderOffset]
                        blendSrc = gl.ONE
                        blendDst = gl.ONE_MINUS_SRC_ALPHA
            ...
            // 【性能优化 2】提取重复的 VBO (顶点/UV) 绑定逻辑
            // 原始代码在 if 和 else 分支中写了两遍一模一样的缓冲区绑定代码
            if (o.vertex == null) o.vertex = gl.createBuffer()
            gl.bindBuffer(gl.ARRAY_BUFFER, o.vertex)
            gl.bufferData(gl.ARRAY_BUFFER, s, gl.DYNAMIC_DRAW)
            gl.enableVertexAttribArray(shaderSet.attributePositionLocation)
            gl.vertexAttribPointer(shaderSet.attributePositionLocation, 2, gl.FLOAT, false, 0, 0)

            if (o.uv == null) o.uv = gl.createBuffer()
            gl.bindBuffer(gl.ARRAY_BUFFER, o.uv)
            gl.bufferData(gl.ARRAY_BUFFER, a, gl.DYNAMIC_DRAW)
            gl.enableVertexAttribArray(shaderSet.attributeTexCoordLocation)
            gl.vertexAttribPointer(shaderSet.attributeTexCoordLocation, 2, gl.FLOAT, false, 0, 0)
            ...
            if (isMaskSetup) {
                ...
                const channelNo = f._layoutChannelNo || 0
                const colorFlag = f.getClippingManager().getChannelFlagAsColor(channelNo)
                gl.uniform4f(shaderSet.uniformChannelFlagLocation, colorFlag.R, colorFlag.G, colorFlag.B, colorFlag.A)
                gl.uniformMatrix4fv(shaderSet.uniformClipMatrixLocation, false, f._matrixForMask.getArray())

                const bounds = f._layoutBounds
                gl.uniform4f(
                    shaderSet.uniformBaseColorLocation,
                    2 * bounds.x - 1,
                    2 * bounds.y - 1,
                    2 * bounds.getRight() - 1,
                    2 * bounds.getBottom() - 1,
                )
            } else {
                const drawBuffer = t.getClippingContextBufferForDraw()
                if (drawBuffer != null) {
                    gl.activeTexture(gl.TEXTURE1)
                    const colorBuffer = drawBuffer.getClippingManager().getColorBuffer()
                    gl.bindTexture(gl.TEXTURE_2D, colorBuffer)
                    gl.uniform1i(shaderSet.samplerTexture1Location, 1)
                    gl.uniformMatrix4fv(
                        shaderSet.uniformClipMatrixLocation,
                        false,
                        drawBuffer._matrixForDraw.getArray(),
                    )

                    const channelNo = drawBuffer._layoutChannelNo || 0
                    const colorFlag = drawBuffer.getClippingManager().getChannelFlagAsColor(channelNo)
                    gl.uniform4f(
                ...
                gl.bindTexture(gl.TEXTURE_2D, e)
                gl.uniform1i(shaderSet.samplerTexture0Location, 0)
                gl.uniformMatrix4fv(shaderSet.uniformMatrixLocation, false, u.getArray())
                gl.uniform4f(shaderSet.uniformBaseColorLocation, h.R, h.G, h.B, h.A)
            }

            // 3. 绑定 IBO (索引缓冲区) 并设置混合模式
            if (o.index == null) o.index = gl.createBuffer()
            gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, o.index)
            gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, r, gl.DYNAMIC_DRAW)
        ...
        releaseShaderProgram() {
            ...
            for (let t = 0; t < this._shaderSets.length; t++) {
                if (this._shaderSets[t].shaderProgram) {
                    gl.deleteProgram(this._shaderSets[t].shaderProgram)
        ...
        generateShaders() {
            ...
            // 【性能优化 3】使用数组初始化代替循环 push，预分配内存
            this._shaderSets = Array.from({ length: 10 }, () => ({}))

            const prog0 = this.loadShaderProgram(fe, xe)
            const prog1 = this.loadShaderProgram(ye, ve)
            const prog2 = this.loadShaderProgram(Me, Pe)
            const prog3 = this.loadShaderProgram(Me, Ce)

            this._shaderSets[0].shaderProgram = prog0
            this._shaderSets[1].shaderProgram = prog1
            this._shaderSets[2].shaderProgram = prog2
            this._shaderSets[3].shaderProgram = prog3
            this._shaderSets[4].shaderProgram = prog1
            this._shaderSets[5].shaderProgram = prog2
            this._shaderSets[6].shaderProgram = prog3
            this._shaderSets[7].shaderProgram = prog1
            this._shaderSets[8].shaderProgram = prog2
            this._shaderSets[9].shaderProgram = prog3

            // 【性能优化 4】使用循环一次性获取 Location，删除上百行的硬编码冗余
            for (let i = 0; i < 10; i++) {
                const set = this._shaderSets[i]
                const prog = set.shaderProgram

                // 注意：WebGL 规范中，如果 shader 没用到该变量，会返回 -1 或 null，可以直接安全地存起来
                set.attributePositionLocation = gl.getAttribLocation(prog, 'a_position')
                set.attributeTexCoordLocation = gl.getAttribLocation(prog, 'a_texCoord')
                set.samplerTexture0Location = gl.getUniformLocation(prog, 's_texture0')
                set.samplerTexture1Location = gl.getUniformLocation(prog, 's_texture1')
                set.uniformMatrixLocation = gl.getUniformLocation(prog, 'u_matrix')
                set.uniformClipMatrixLocation = gl.getUniformLocation(prog, 'u_clipMatrix')
                set.uniformChannelFlagLocation = gl.getUniformLocation(prog, 'u_channelFlag')
                set.uniformBaseColorLocation = gl.getUniformLocation(prog, 'u_baseColor')
            }
        }

        loadShaderProgram(t, e) {
            const gl = this.gl
            let i = gl.createProgram()
            let s = this.compileShaderSource(gl.VERTEX_SHADER, t)
            if (!s) return Tt('Vertex shader compile error!'), 0

            let r = this.compileShaderSource(gl.FRAGMENT_SHADER, e)
            if (!r) return Tt('Fragment shader compile error!'), 0

            gl.attachShader(i, s)
            gl.attachShader(i, r)
            gl.linkProgram(i)

            if (gl.getProgramParameter(i, gl.LINK_STATUS)) {
                gl.deleteShader(s)
                gl.deleteShader(r)
                return i
            } else {
                Tt('Failed to link program: {0}', gl.getProgramInfoLog(i))
                gl.deleteShader(s)
                gl.deleteShader(r)
                if (i) gl.deleteProgram(i)
                return 0
            }
        }
        ...
        compileShaderSource(t, e) {
            ...
            if (!gl.getShaderParameter(s, gl.COMPILE_STATUS)) {
                Tt('Shader compile log: {0} ', gl.getShaderInfoLog(s))
                gl.deleteShader(s)
                return null
            }
            return s
    ...
    class Ie extends b {
        ...
        init() {
            var t
            super.init(),
                (null == (t = this.settings.getEyeBlinkParameters()) ? void 0 : t.length) > 0 &&
                    (this.eyeBlink = oe.create(this.settings)),
    ...
    function Ee(t) {
        ;(t = Object.assign({ logFunction: console.log, loggingLevel: St.LogLevel_Verbose }, t)),
            Ct.startUp(t),
            Ct.initialize()
    }
    class Fe {
        static create(t) {
            ...
            'number' == typeof t.FadeInTime &&
                ((e._fadeTimeSeconds = t.FadeInTime), e._fadeTimeSeconds <= 0 && (e._fadeTimeSeconds = 0.5))
            const i = t.Groups,
                s = i.length
            for (let r = 0; r < s; ++r) {
                const t = i[r],
    ...
    var Re = ((t) => ((t[(t.CubismPhysicsTargetType_Parameter = 0)] = 'CubismPhysicsTargetType_Parameter'), t))(
            Re || {},
        ),
        Oe = ((t) => (
    ...
    class je {
        ...
        getGravity() {
            const t = new ut(0, 0)
            return (
                (t.x = this._json.Meta.EffectiveForces.Gravity.X), (t.y = this._json.Meta.EffectiveForces.Gravity.Y), t
            )
        }
        getWind() {
            const t = new ut(0, 0)
            ...
            for (let p = 0; p < this._physicsRig.subRigCount; ++p) {
                ...
                for (let e = 0; e < n.outputCount; ++e) {
                    ...
                    ;-1 == h[e].destinationParameterIndex &&
                        (h[e].destinationParameterIndex = t.getParameterIndex(h[e].destination.id))
                    const s = new ut()
